...
const ProductScreen = () => {
  ...
  // our url looks like = http://localhost:3000/cart/45783487394u3sl?qty=5
        ...
        <>
          <Grid templateColumns="5fr 4fr 3fr" gap="10">
            ...
            <Flex direction="column">
              ...
              <Heading as="h2" fontSize={{ lg: "4xl", base: "2xl" }} mb="2">
                {product.name}
              </Heading>
              <Rating
            ...
            {/* Column 3 */}
            <Flex direction="column" borderColor="blackAlpha.500">
              <Flex
          ...
          <Box mt="10">
            <Box>
              ...
              <Box
                ...
                rounded="mb"
                mb="1"
                bgGradient="linear(red.100 0%, orange.100 20%, yellow.100 40%)"
              >
